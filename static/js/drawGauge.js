...
function drawGaugeABV(data) {
	let degree = parseFloat(data.ABV_avg) * (180/11);
	...
	title: `<b> ABV % for </b> <br>${data.Style}<br>`,
	height: 550,
	width: 550,
...
function drawGaugeIBU(data) {
	let degree = parseFloat(data.IBU_avg) * (180/11);
	...
	title: `<b> IBU % for </b> <br>${data.Style}<br>`,
	height: 550,
	width: 550,
	xaxis: {zeroline:false, showticklabels:false,
	           showgrid: false, range: [-1, 1]},
...
function drawGaugeSRM(data) {
	let degree = parseFloat(data.SRM_avg) * (180/11);
	...
	title: `<b> SRM % for </b> <br>${data.Style}<br>`,
	height: 550,
	width: 550,
	xaxis: {zeroline:false, showticklabels:false,
	           showgrid: false, range: [-1, 1]},
